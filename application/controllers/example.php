...
class Example extends CI_Controller {
    ...
    public function index() {
        ...
        echo ''
        . '<form action="'.  base_url("debug/login").'" method="post">'
    ...
    public function login(){
             ...
             if ($this->aauth->login($this->input->post('email'), $this->input->post('password'), FALSE, $this->aauth->generate_unique_totp_secret())){
            echo 'Welcome'.$this->aauth->get_user_var('full_name')."!";
             } else
